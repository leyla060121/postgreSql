...
(
    ...
    student_dob DATE,
    CONSTRAINT student_age_check CHECK(student_age BETWEEN 0 AND 20)-- strudent_age değişkeninin 0-20 aralıkta olamaz
);
-- Tam veri girişi
...
update students set student_name='LEO OCEAN' where student_id='101'; --id char tipinde olduğu için kabul etmiyor

--alter  -> değişiklik yapıyor
--update -> güncelliyor
